...
export default function Hero() {
  return (
    <section className="bg-airbnb-soft">
      <div className="page-shell grid min-h-[560px] items-center gap-10 py-10 lg:grid-cols-[1fr_1.05fr] lg:py-14">
        <div className="max-w-xl">
          ...
          <h1 className="text-4xl font-bold tracking-normal text-airbnb-ink sm:text-5xl lg:text-6xl">
            Find stays that feel made for the trip.
          </h1>
          <p className="mt-5 text-lg leading-8 text-airbnb-muted">
        ...
        <div className="relative min-h-[420px] overflow-hidden rounded-[2rem] shadow-card">
          ...
          <div className="absolute inset-x-4 bottom-4 grid gap-3 sm:grid-cols-2">
            <div className="rounded-2xl bg-white/95 p-4 shadow-card backdrop-blur">
              ...
              <p className="mt-1 text-sm text-airbnb-muted">Beach homes, private villas, and breezy stays.</p>
            </div>
            <div className="rounded-2xl bg-white/95 p-4 shadow-card backdrop-blur">
              <div className="flex items-center gap-2 text-sm font-bold">
              ...
              <p className="mt-1 text-sm text-airbnb-muted">Weekend escapes and week-long retreats.</p>
            </div>
          </div>
        </div>
      </div>
